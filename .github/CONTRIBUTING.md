# Contributing to the hello48 R package

You want to contribute to **hello48**? Great! 

Please submit questions, bug reports, and requests in the [issues tracker](https://github.com/noamross/hello48/issues). Please submit bug
